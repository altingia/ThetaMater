# ThetaMater: Rapid and scalable Bayesian estimation of the population size parameter theta from diverse genetic data
...
The R package ThetaMater is freely available to download and distribute from github <https://github.com/radamsRHA/ThetaMater/>. To install and load ThetaMater, you must first install the R packages `devtools`, `Rcpp`, and `MCMCpack`. Additionally, make sure the most updated version of R is installed (>= R.3.3.1)
```
