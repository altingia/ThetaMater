...
The R package ThetaMater is freely available to download and distribute from github <https://github.com/radamsRHA/ThetaMater/>. To install and load ThetaMater, you must first install the R packages `devtools`, `Rcpp`, and `MCMCpack`. Additionally, make sure the most updated version of R version 3.3.3 is installed (see above warning, once these packages are updated ThetaMater will be compatable with R version 3.3.4). Download R version 3.3.3 here: https://cran.r-project.org/bin/macosx/.
```
